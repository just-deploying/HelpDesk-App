...
class Setiment2SupabaseUser extends BaseAuthUser {
  Setiment2SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> setiment2SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = Setiment2SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
