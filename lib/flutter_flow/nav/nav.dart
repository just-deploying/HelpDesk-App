...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? UploadpageWidget() : LoginpageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => UploadpageWidget(
            selectedAudioUrl: params.getParam(
              'selectedAudioUrl',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: CallhistoryWidget.routeName,
          path: CallhistoryWidget.routePath,
          builder: (context, params) => CallhistoryWidget(),
        ),
        FFRoute(
          name: HistorypageWidget.routeName,
          path: HistorypageWidget.routePath,
          builder: (context, params) => HistorypageWidget(
            transcription: params.getParam(
              'transcription',
              ParamType.String,
            ),
            emotiontest: params.getParam(
              'emotiontest',
              ParamType.String,
            ),
            improvement: params.getParam(
              'improvement',
              ParamType.String,
            ),
          ),
