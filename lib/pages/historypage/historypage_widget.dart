...
import 'historypage_model.dart';
export 'historypage_model.dart';
...
class HistorypageWidget extends StatefulWidget {
  const HistorypageWidget({
    ...
    required this.emotiontest,
    required this.improvement,
  });

  final String? transcription;
  final String? emotiontest;
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          '6ndo70vb' /* Executive Suggestions */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .titleLarge
                                            .override(
